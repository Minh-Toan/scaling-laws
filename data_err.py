...
'''
collect data for BO error using HMC sampling
'''
...
folder=f'err_data_beta_03/'
os.makedirs(folder, exist_ok=True)

for i in range(16):
    filename = folder+f'iter_{i+1}.csv'
    ...
    for alpha in alphas:
        ...
        errs.append(np.mean(test_errs[-400:]) )
    np.savetxt(filename, errs, delimiter=',')
